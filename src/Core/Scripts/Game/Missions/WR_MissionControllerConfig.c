...
class WR_MissionControllerConfig
{
	...
	[Attribute(defvalue: "2", uiwidget: UIWidgets.Slider, params: "0 30 0.01", desc: "(m) How long to wait after game mode start before starting missions")]
	float m_fInitialMissionDelay;
	
	[Attribute(defvalue: "5", uiwidget: UIWidgets.Slider, params: "0.01 30 0.01", desc: "(m) How long to wait to start a new mission after one ends.")]
