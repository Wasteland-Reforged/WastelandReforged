class WR_ResourceNamesWeighted
{
	...
	static WR_WeightedItemArray<ResourceName> GetMachineGuns()
	{
		...
		MachineGuns.AddItem(2.0, "{5F365605E36597FB}Prefabs/Weapons/MachineGuns/RPK74/MG_RPK74.et");
		MachineGuns.AddItem(4.0, "{5F365605E36597FB}Prefabs/Weapons/MachineGuns/RPK74/MG_RPK74N.et");
	...
	static WR_WeightedItemArray<ResourceName> GetUtilityItems()
	{
		...
		UtilityItems.AddItem(5.0, "{33B2DFDCD0EBA3DB}Prefabs/Items/Equipment/Kits/RepairKit_01/RepairKit_01_wrench.et");
